    ...
    >
      <RouterLink :to="{ name: 'home' }">
        <div class="flex items-center gap-3">
          ...
          <p class="text-2xl">Weather or Not!</p>
        </div>
      </RouterLink>
      ...
      >
        <div class="text-black">
          ...
          <p class="mb-4">
            Weather or not allows you to track the current and
            future weather of cities of your choosing!
          </p>
          <h2 class="text-2xl">How it works:</h2>
          <ol class="list-decimal list-inside mb-4">
            <li>
              Search for a city of interest by entering the name into the
              search bar!
            </li>
            <li>
              Select the city within the list of results, this will take
              you to the current weather for your selection!
            </li>
            <li>
              You can track the city by clicking on the "+" icon in the
